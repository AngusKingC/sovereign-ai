        ...
        try:
            ...
            try:
                ...
                await self._emitter.emit(TraceEvent(
                    ...
                    component=TraceComponent.ADAPTER,
                    message="Trace emission failed in OpenAI adapter call start",
            ...
            try:
                ...
                await self._emitter.emit(TraceEvent(
                    event_type=TraceEventType.ADAPTER_ERROR,
                    component=TraceComponent.ADAPTER,
                    message="Trace emission failed in OpenAI adapter response",
                    level=TraceLevel.WARNING,
                    data={"error": str(e)},
                    duration_ms=0,
                ))
            ...
            try:
                ...
                await self._emitter.emit(TraceEvent(
                    event_type=TraceEventType.ADAPTER_ERROR,
                    component=TraceComponent.ADAPTER,
                    message="Trace emission failed in OpenAI adapter error handler",
                    level=TraceLevel.WARNING,
