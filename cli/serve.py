...
def serve(
    ...
    ),  # nosec B104 — configurable default, user can override via --host
    ...
    escalation_engine = EscalationEngine(
        approval_gate=approval_gate, memory_router=memory_router, emitter=emitter
    )
    ...
    WorkerPersistence(
        memory_router=memory_router, emitter=emitter, obsidian_vault_path=None
    )
